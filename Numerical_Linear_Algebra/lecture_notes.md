...
## 6. Итерационные решатели

### Метод CGR 

Мне кажется, что максимально емко идея метода CGR описана у Булата (хотя в Сааде стопудово оно же есть). Но привожу полезную пикчу из его диплома

![alt text](image-4.png)

В чем может быть проблема метода? Несмотря на хорошее обобщение на задачи со многими правыми частями (естественно обобщается он, не надо ничего нового придумывать), ему нужно хранить два базиса одновременно, что потенциально уменьшает вдвое(!!!!!!) число итераций, которые может сделать метод. Например, в случае моей научки это максимально критично.
